...
urlpatterns = [
    ...
    path('lote/<int:lote_id>/auto_save/', banco.api_auto_guardar_arqueo, name='api_auto_guardar_arqueo'),
    ...
    path('aporte/editar/<int:aporte_id>/', banco.editar_aporte, name='editar_aporte'),
    ...
    # --- RUTA NUEVA PARA AUTO-SAVE ---
    path('trabajadores/rendicion/<int:rendicion_id>/auto_save/', caja_trabajador.api_auto_guardar_rendicion, name='api_auto_guardar_rendicion'),
    ...
    # --- RUTA CAMBIADA: AHORA LLEVA A LA PANTALLA INTERMEDIA ---
    path('remuneraciones/vista-excel/<int:id>/', remuneraciones.vista_excel_simulacion, name='vista_excel_simulacion'),
    ...
    # Rutas para acciones desde MODALES
    path('remuneraciones/entidad/crear/', remuneraciones.crear_entidad_previsional, name='crear_entidad_previsional'),
