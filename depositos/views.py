...
def home(request):
    context = {}
    return render(request, 'depositos/home.html', context)
...
def gestion_trabajadores(request):
    ...
    return render(request, 'depositos/gestion_trabajadores.html', context)

# === VISTA DEL MENÚ (4 OPCIONES) ===
@login_required
def total_dia(request):
    """
    Esta vista renderiza EL MENÚ de selección (Bodegas, Total Día, Mensual).
    Usamos este nombre para mantener compatibilidad con el Navbar.
    """
    return render(request, 'depositos/menu_flujocaja_diario.html')
...
def resumen_consolidado(request):
    ...
    return render(request, 'depositos/total_dia.html', context)
...
def deposito_bodega(request, bodega_nombre):
    ...
    return render(request, 'depositos/deposito_bodega.html', context)
...
def reportes_mensuales(request):
    ...
    return render(request, 'depositos/reportes_mensuales.html', context)
...
def editar_lote(request, lote_id):
    ...
    return render(request, 'depositos/lote_editor.html', context)
...
def agregar_aporte(request, lote_id):
    ...
    return render(request, 'depositos/agregar_aporte.html', context)
...
def agregar_trabajador(request):
    ...
    return render(request, 'depositos/agregar_trabajador.html', context)
...
def editar_trabajador(request, trabajador_id):
    ...
    return render(request, 'depositos/editar_trabajador.html', context)
